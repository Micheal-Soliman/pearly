...
export default function SqueezePage() {
  ...
  const handleAddToCart = () => {
    ...
    const uniqueId = `squeez-s-${selectedShade}`;
    const itemToAdd = {
      ...product,
      id: uniqueId,
      name: `Squeeze Tube Lipgloss (Shade: ${shadeName})`,
      selectedType: 'squeez' as const,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                ...
                <div className="absolute top-6 left-6 flex flex-col gap-3">
                  ...
                  {hasDiscount && (
                    <span className="px-4 py-1.5 bg-[#d6869d] text-white text-sm font-bold rounded-full shadow-xl backdrop-blur-sm flex items-center gap-1.5">
                      <span>−{Math.round((1 - currentPrice / originalPrice) * 100)}%</span>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="p-5 bg-gradient-to-br from-[#fff5f7] to-white rounded-2xl border border-[#ffd3df]">
                <h3 className="font-semibold text-gray-900 mb-3">Squeeze Tube Features</h3>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#d6869d]" />
                    Convenient squeeze packaging
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#d6869d]" />
                    10ml extra value size
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[#d6869d]" />
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-white rounded-xl border border-gray-100">
                      ...
                      <p className="font-semibold text-gray-900 mt-1">10ml</p>
                    </div>
                    <div className="p-4 bg-white rounded-xl border border-gray-100">
                      <span className="text-xs text-gray-500 uppercase tracking-wider">Category</span>
                      <p className="font-semibold text-gray-900 mt-1">Squeeze Tube</p>
                    </div>
                    <div className="p-4 bg-white rounded-xl border border-gray-100">
